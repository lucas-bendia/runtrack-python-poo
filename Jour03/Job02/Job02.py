class CompteBancaire:
    ...
    def virement(self, compte_destinataire, montant):
        if self.__solde >= montant:
            ...
            print("Le virement de ", montant, " euros a bien été effectué vers le compte ",
                  compte_destinataire.__numero_compte)
            self.afficherSolde()
        else:
...
compte1 = CompteBancaire("4987 4523 0147 7453", "Marc", "Evans", 1000)
