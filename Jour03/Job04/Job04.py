...
joueur1 = Joueur("Mouley", 14, "Attaquant")
joueur2 = Joueur("DirtyMan", 8, "Attaquant")
joueur3 = Joueur("Neymar", 10, "Attaquant")
joueur4 = Joueur("Karim", 7, "Milieu")
joueur5 = Joueur("Pinkmin", 6, "Milieu")
joueur6 = Joueur("Varane", 4, "Défenseur")

# Création des équipes
equipe1 = Equipe("FC Ratfox")
equipe2 = Equipe("Real OG")
...
equipe1.mettreAJourStatistiquesJoueur("Mouley", buts=1, passes=1)
equipe2.mettreAJourStatistiquesJoueur("DirtyMan", jaunes=1)
equipe1.mettreAJourStatistiquesJoueur("Neymar", jaunes=1)
equipe2.mettreAJourStatistiquesJoueur("Pinkmin", rouges=1)
